  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100 p-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-extrabold mb-6 text-center text-purple-800 drop-shadow animate-bounce">
          🍬 Sweet Shop Inventory
        </h1>
        {error && !error.toLowerCase().includes("not enough stock") && (
          <div className="bg-red-200 text-red-800 p-2 mb-2 rounded shadow">{error}</div>
        )}
        {success && (
          <div className="bg-green-200 text-green-800 p-2 mb-2 rounded shadow">{success}</div>
        )}
